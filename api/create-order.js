...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const payload = JSON.stringify({
      ...
      order_meta: {
        return_url: `https://${req.headers.host || 'yahya.in'}/payment-success.html?order_id={order_id}&course_id=${encodeURIComponent(courseId || '')}&course_name=${encodeURIComponent(courseName || '')}`
      },
